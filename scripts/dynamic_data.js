...
$(function () {
    ...
    var sampleFile = false, // Toggle to prevent making API calls using sample json files instead
        ...
        defaultLocation = candidateLocations.Brisbane; // Currently used location

    //Initalise Configuration Object
    initialConfiguration()
        .then(function (Arr1) {
            console.log(Arr1);
            console.log("The initial latitude is: " + Arr1[0].source.latitude); // Array!!!!!
            console.log("The initial longitude is: " + Arr1[0].source.longitude);
...
function initialConfiguration() {
    ...
    return new Promise(
        function (resolve, reject) {
            ...
            if (configurationSet) {
                console.log("Configuration Initialised!");
